...
let StripeModule = StripeModule_1 = class StripeModule extends nestjs_modules_1.createConfigurableDynamicRootModule(stripe_constants_1.STRIPE_MODULE_CONFIG_TOKEN, {
    ...
    providers: [
        {
            ...
            useFactory: (config) => {
                var _a, _b, _c;
                const controllerPrefix = ((_a = config.webhookConfig) === null || _a === void 0 ? void 0 : _a.controllerPrefix) || 'stripe';
                Reflect.defineMetadata(constants_1.PATH_METADATA, controllerPrefix, stripe_webhook_controller_1.StripeWebhookController);
                (_c = (_b = config.webhookConfig) === null || _b === void 0 ? void 0 : _b.decorators) === null || _c === void 0 ? void 0 : _c.forEach((deco) => {
        ...
        },
        {
            ...
            useFactory: (_a) => {
                var { apiKey, typescript = true, apiVersion = '2020-03-02', webhookConfig } = _a, options = __rest(_a, ["apiKey", "typescript", "apiVersion", "webhookConfig"]);
                return new stripe_1.default(apiKey, Object.assign({ typescript,
                    apiVersion }, options));
            },
            inject: [stripe_constants_1.STRIPE_MODULE_CONFIG_TOKEN],
        },
    ...
    async onModuleInit() {
        ...
        if (this.stripeModuleConfig.webhookConfig &&
            !((_a = this.stripeModuleConfig.webhookConfig) === null || _a === void 0 ? void 0 : _a.stripeWebhookSecret)) {
        ...
        const [stripeWebhookService] = await ((await this.discover.providersWithMetaAtKey(stripe_constants_1.STRIPE_WEBHOOK_SERVICE)) || []).map((x) => x.discoveredClass.instance);
        ...
        const grouped = lodash_1.groupBy(eventHandlerMeta, (x) => x.discoveredMethod.parentClass.name);
        const webhookHandlers = lodash_1.flatten(Object.keys(grouped).map((x) => {
        ...
        const handleWebhook = async (webhookEvent) => {
            ...
            if (handlers.length) {
                if ((_c = (_b = (_a = this.stripeModuleConfig) === null || _a === void 0 ? void 0 : _a.webhookConfig) === null || _b === void 0 ? void 0 : _b.loggingConfiguration) === null || _c === void 0 ? void 0 : _c.logMatchingEventHandlers) {

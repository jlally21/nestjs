...
exports.yamlFileToJson = (filePath) => {
    const fileContents = fs.readFileSync(filePath, 'utf-8');
    return js_yaml_1.load(fileContents);
};
exports.getVersionedMetadataPathAndConfig = (v) => {
...
exports.copyCleanTemplateYamlFile = (yamlPath) => {
...
__decorate([
    hasura_decorators_1.TrackedHasuraEventHandler({
...
__decorate([
    hasura_decorators_1.TrackedHasuraScheduledEventHandler({

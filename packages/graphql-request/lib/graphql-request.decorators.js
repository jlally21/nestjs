 ...
 */
exports.InjectGraphQLConfig = nestjs_common_1.makeInjectableDecorator(graphql_request_constants_1.GraphQLClientConfigInject);
/**
 * Injects the GraphQL client provided by this module into a service/controller
 */
exports.InjectGraphQLClient = nestjs_common_1.makeInjectableDecorator(graphql_request_constants_1.GraphQLClientInject);

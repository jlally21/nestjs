...
let GraphQLRequestModule = class GraphQLRequestModule extends nestjs_modules_1.createConfigurableDynamicRootModule(graphql_request_constants_1.GraphQLClientConfigInject, {
    providers: [
        {

 ...
 */
let WebhooksModule = class WebhooksModule extends nestjs_modules_1.createConfigurableDynamicRootModule(webhooks_contants_1.WEBHOOK_MODULE_PROVIDED_CONFIG_TOKEN, {
    providers: [
        {
